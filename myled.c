...
#include <linux/io.h>
MODULE_AUTHOR("Ryuichi Ueda & Yuma Ito & Koutarou Murabayasi");
 ...
 static ssize_t led_write(struct file* filp, const char* buf, size_t count, loff_t* pos)
	 {
		 ...
		 gpio_base[7] = 1 << 24;												 }       else if(c == '4'){													 gpio_base[10] = 1 << 23;			
         }
		 else if(c == '5'){
   		 gpio_base[7] = 1 << 23;
																			      }
...
const u32 mask2 = ~(0x7<<shift2);																     gpio_base[index2] = (gpio_base[index2] & mask2 ) | (0x1 << shift2);										
const u32 led3 = 23;						 
